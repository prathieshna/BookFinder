...
class BookFavouriteAdapter(
    ...
    inner class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun setData(item: Item?, position: Int) {
            ...
            tvBookTitle.text = favouriteItem?.volumeInfo?.title
            tvBookSubtitle.text = favouriteItem?.volumeInfo?.subtitle
            tvBookAuthor.text = favouriteItem?.volumeInfo?.authors?.get(0)
